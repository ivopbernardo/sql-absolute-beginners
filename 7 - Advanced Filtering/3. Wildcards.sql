...
/* In this wildcard selection, the % works as "does not matter what's before Smith". 
Translating this query into a sentence would be: 
"we are selecting "every row where the full name ends with "Smith", regardless of what's before that"
*/
