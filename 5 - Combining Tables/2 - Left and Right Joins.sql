...
# Notice how when we don't have a "key" matching on the opposing table
# the rest of the fields are null

# If I use the ID coming from the "master table" , I'll be able
# to see it now on this query - although the name will be null because
# we still don't know the name of this customer
